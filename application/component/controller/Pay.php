...
class Pay extends Controller
{
    ...
    public function wxPay(){
        ...
        // 统一下单类
        require_once env('extend_path') . "wxPay/lib/WxPay.Api.php";
        // 签名类
        require_once env('extend_path') . "wxPay/example/WxPay.JsApiPay.php";
        $input = new \WxPayUnifiedOrder;
        $input->SetBody($this -> body);
        $input->SetOut_trade_no($this -> out_trade_no);
        $input->SetTotal_fee((int) ($this -> total_fee * 100));
        $input->SetNotify_url(url('index/order/notify', [], false, true));
        ...
        // 再次签名
        $tools = new \JsApiPay();
        $sign = json_decode($tools->GetJsApiParameters($result), true);
    ...
    public function notify(){
        ...
        $arr = json_decode(json_encode(simplexml_load_string($xml, 'SimpleXMLElement', LIBXML_NOCDATA)), true);
      	...
      	// 应支付金额
        $price = model('Order') -> where('order_sn', $arr['out_trade_no']) -> value('order_count');
        $price = (int) ($price * 100);
    ...
    public function qcode(){
        require_once env('extend_path') . "wxPay/example/qrcode.php";
    }
    ...
    public function aliPay(){
        ...
        require_once env('extend_path') . "aliPay/pagepay/pagepay.php";
    }
    ...
    public function alinotify(){
        ...
        $res = model('PayRecord') -> allowField(true) -> save($data);
      	...
      	//require_once env('extend_path') . "aliPay/config.php";
      	//require_once env('extend_path') . "aliPay/pagepay/service/AlipayTradeService.php";
